...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TollGuruCalculator.GeoCordinates();
  });
  ...
  describe('GeoCordinates', function() {
    it('should create an instance of GeoCordinates', function() {
      // uncomment below and update the code to test GeoCordinates
      //var instane = new TollGuruCalculator.GeoCordinates();
      //expect(instance).to.be.a(TollGuruCalculator.GeoCordinates);
    });
