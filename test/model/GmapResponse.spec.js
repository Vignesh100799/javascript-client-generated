...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TollGuruCalculator.GmapResponse();
  });
  ...
  describe('GmapResponse', function() {
    it('should create an instance of GmapResponse', function() {
      // uncomment below and update the code to test GmapResponse
      //var instane = new TollGuruCalculator.GmapResponse();
      //expect(instance).to.be.a(TollGuruCalculator.GmapResponse);
    });
