...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TollGuruCalculator.GmapRouteResponse();
  });
  ...
  describe('GmapRouteResponse', function() {
    it('should create an instance of GmapRouteResponse', function() {
      // uncomment below and update the code to test GmapRouteResponse
      //var instane = new TollGuruCalculator.GmapRouteResponse();
      //expect(instance).to.be.a(TollGuruCalculator.GmapRouteResponse);
    });
