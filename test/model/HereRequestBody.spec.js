...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TollGuruCalculator.HereRequestBody();
  });
  ...
  describe('HereRequestBody', function() {
    it('should create an instance of HereRequestBody', function() {
      // uncomment below and update the code to test HereRequestBody
      //var instane = new TollGuruCalculator.HereRequestBody();
      //expect(instance).to.be.a(TollGuruCalculator.HereRequestBody);
    });
    ...
    it('should have the property truck (base name: "truck")', function() {
      // uncomment below and update the code to test the property truck
      //var instane = new TollGuruCalculator.HereRequestBody();
      //expect(instance).to.be();
    });
    ...
    it('should have the property stateMileage (base name: "state_mileage")', function() {
      // uncomment below and update the code to test the property stateMileage
      //var instane = new TollGuruCalculator.HereRequestBody();
      //expect(instance).to.be();
    });
