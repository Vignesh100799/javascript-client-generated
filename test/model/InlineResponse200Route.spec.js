...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TollGuruCalculator.InlineResponse200Route();
  });
  ...
  describe('InlineResponse200Route', function() {
    it('should create an instance of InlineResponse200Route', function() {
      // uncomment below and update the code to test InlineResponse200Route
      //var instane = new TollGuruCalculator.InlineResponse200Route();
      //expect(instance).to.be.a(TollGuruCalculator.InlineResponse200Route);
    });
