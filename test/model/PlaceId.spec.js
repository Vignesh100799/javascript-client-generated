...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TollGuruCalculator.PlaceId();
  });
  ...
  describe('PlaceId', function() {
    it('should create an instance of PlaceId', function() {
      // uncomment below and update the code to test PlaceId
      //var instane = new TollGuruCalculator.PlaceId();
      //expect(instance).to.be.a(TollGuruCalculator.PlaceId);
    });
